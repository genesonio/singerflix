...
export default function Dashboard() {
  ...
  return (
    <section style={{ padding: '1.5rem' }} >
      ...
      <section style={{ backgroundColor: '#bcbcbc', padding: '1.5rem' }}>
        <H2>Resumo</H2>
        <Table>
          <TableHead>
            <TableRow style={{ backgroundColor: '#444444' }}>
              <TableCell style={{ backgroundColor: '#5b5b5b' }}>Recurso</TableCell>
              <TableCell style={{ backgroundColor: '#5b5b5b' }}>Registro</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            {
