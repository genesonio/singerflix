...
export const locale: Locale = {
  ...
  translations: {
    ...
    buttons: {
      ...
      confirmRemovalMany: 'Confirme a remoção de ({count}) registro',
    ...
    messages: {
      ...
      error404Resource: 'Recurso identificado pelo id: {{resourceId}} não pôde ser encontrado',
      error404Action: 'Recurso identificado pelo id: {{resourceId}} não possui uma ação com nome: {{actionName}} ou você não está autorizado a usá-la!',
      error404Record: 'Recurso identificado pelo id: {{resourceId}} não possui um registro com id: {{recordId}} ou você não está autorizado a acessá-lo!',
